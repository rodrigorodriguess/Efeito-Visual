// Para fazer com que seja possível fazer isso, primeiro pegamos o texto que desejamos fazer aparecer, depois pegamos a posição do texto ou seja aonde ele está com base no top, por último pegamos a altura da janela.

function scrollAppear() {
  const introText = document.querySelector(".intro-text"); // Pegando o texto que desejo modificar.
  const introPostion = introText.getBoundingClientRect().top; // Pegando a posição do texto com base no topo da janela.
